...
```
cd existing_repo
git remote add origin https://gitlab.com/henry808v21/projects/aimusic.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/henry808v21/projects/aimusic/-/settings/integrations)
